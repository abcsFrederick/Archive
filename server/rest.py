...
class Archive(Resource):
    ...
    def getSAIPProjects(self, text):
        ...
        return saipArchive.getProjects(text)
    ...
    def getExperiments(self, id):
        saipArchive = SAIPArchive()
        return saipArchive.getExperiments(id)
    ...
    def getPatients(self, id):
        saipArchive = SAIPArchive()
        return saipArchive.getPatients(id)
    ...
    def getStudies(self, id):
        saipArchive = SAIPArchive()
        return saipArchive.getStudies(id)
    ...
    # series is item in girder
    # return DCM files with path attr under series as files in girder
    # {
    #   {
    #       name: '00637254',
    #       path: '/00001255/00001537/00010054'
    #   },
    #   {}
    # }
    @access.user
    @autoDescribeRoute(
        ...
        .param('id', 'series id.', paramType='path')
        .errorResponse())
